...
Curray.prototype.splice = function (fromIndex, removeCount, element) {
    if (removeCount === 0) {
        ...
        this[5] = this[7] // Curray { 0: 'apple', 1: 'orange', 2: 'lemon', 3: 'banana', 4: 'coco', 5: 'peach', 6: 'pinapple', 7: 'peach', length: 8 }
        ...
        this.length = 6 // Curray { 0: 'apple', 1: 'orange', 2: 'lemon', 3: 'banana', 4: 'coco', 5: 'peach', length: 6 }
