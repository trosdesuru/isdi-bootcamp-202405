...
Curray.prototype.splice = function (fromIndex, removeCount, element) {
    if (removeCount === 0) {
        ...
        delete this[this.length - 1] // Curray { 0: 'yellow', 1: 'green', 2: 'red', 3: 'pink', 4: 'skyblue', 5: 'plum', 6: 'brown', 7: 'gray', 8: 'black', 9: 'white', length: 11 }
        this.length-- // Curray { 0: 'yellow', 1: 'green', 2: 'red', 3: 'pink', 4: 'skyblue', 5: 'plum', 6: 'brown', 7: 'gray', 8: 'black', 9: 'white', length: 10 }

        this[fromIndex] = element // Curray { 0: 'yellow', 1: 'green', 2: 'violet', 3: 'pink', 4: 'skyblue', 5: 'plum', 6: 'brown', 7: 'gray', 8: 'black', 9: 'white', length: 10 }
